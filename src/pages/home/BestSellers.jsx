  ...
  return (
    <div className='max-w-screen-2xl container mx-auto xl:px-28 px-4'>
        <div className='text-center'>
            ...
            <p className='text-black/75 capitalize md:w-2/3 mx-auto mb-8'> Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet aspernatur id eaque sequi debitis beatae aut recusandae ab expedita! Molestias magnam delectus, dicta ea esse deleniti non ab commodi aliquam nemo eaque voluptas maxime quaerat dolor voluptatum quis harum nobis? </p>
        </div>
